...
import com.vivek.BudgetManager.iab.IabBroadcastReceiver;
import com.vivek.BudgetManager.iab.IabHelper;
import com.vivek.BudgetManager.iab.IabResult;
import com.vivek.BudgetManager.iab.Inventory;
import com.vivek.BudgetManager.iab.Purchase;
...
import com.vivek.BudgetManager.view.RatingPopup;
import com.vivek.BudgetManager.view.SettingsActivity;
...
/**
 * BudgetManager application. Implements GA tracking, Batch set-up, Crashlytics set-up && iab.
 *
 * @author Vivek Singh
 */
public class BudgetManager extends Application implements IabBroadcastReceiver.IabBroadcastListener
{
    /**
            ...
            public void onActivityStarted(final Activity activity)
            {
                Batch.Unlock.setUnlockListener(new BatchUnlockListener()
                {
                    ...
                    public void onRedeemAutomaticOffer(Offer offer)
                    {
                        ...
                        {
                            boolean alreadyPremium = UserHelper.isUserPremium(BudgetManager.this);
        ...
        try
        {
            ...
            inventoryListener = new IabHelper.QueryInventoryFinishedListener()
            {
                ...
                public void onQueryInventoryFinished(IabResult result, Inventory inventory)
                {
                     ...
                     */
                    Purchase premiumPurchase = inventory.getPurchase(BudgetManager.SKU_PREMIUM);
            ...
            iabHelper.startSetup(new IabHelper.OnIabSetupFinishedListener()
            {
                public void onIabSetupFinished(IabResult result)
                {
                    ...
                    iabBroadcastReceiver = new IabBroadcastReceiver(BudgetManager.this);
