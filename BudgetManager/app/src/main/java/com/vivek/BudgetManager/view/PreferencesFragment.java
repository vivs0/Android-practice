...
import com.vivek.BudgetManager.BuildConfig;
import com.vivek.BudgetManager.BudgetManager;
import com.vivek.BudgetManager.PremiumCheckStatus;
...
import com.vivek.BudgetManager.notif.DailyNotifOptinService;
import com.vivek.BudgetManager.notif.MonthlyReportNotifService;
...
// ---------------------------------------->
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        limitWarningPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener()
        {
            ...
            public boolean onPreferenceClick(Preference preference)
            {
                ...
                limitEditText.setText(String.valueOf(Parameters.getInstance(getActivity()).getInt(ParameterKeys.LOW_MONEY_WARNING_AMOUNT, BudgetManager.DEFAULT_LOW_MONEY_WARNING_AMOUNT)));
        ...
        filter.addAction(BudgetManager.INTENT_IAB_STATUS_CHANGED);
        ...
        receiver = new BroadcastReceiver()
        {
            ...
            public void onReceive(Context context, Intent intent)
            {
                ...
                else if( BudgetManager.INTENT_IAB_STATUS_CHANGED.equals(intent.getAction()) )
                {
                    try
                    {
                        PremiumCheckStatus status = (PremiumCheckStatus) intent.getSerializableExtra(BudgetManager.INTENT_IAB_STATUS_KEY);
    ...
    {
        limitWarningPreferenceTitle.setTitle(getResources().getString(R.string.setting_category_limit_set_button_title, CurrencyHelper.getFormattedCurrencyString(getActivity(), Parameters.getInstance(getActivity()).getInt(ParameterKeys.LOW_MONEY_WARNING_AMOUNT, BudgetManager.DEFAULT_LOW_MONEY_WARNING_AMOUNT))));
    }
